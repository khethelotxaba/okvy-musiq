...
// NativeMediaPlugin is registered directly in MainActivity below.
// Do not patch android/capacitor.config.json here; Capacitor owns that file
// and its plugin metadata is generated by `npx cap sync android`.
